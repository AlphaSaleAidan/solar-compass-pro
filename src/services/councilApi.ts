    ...
    const roleScanResults: Record<string, { role: string; agent: string; checks: { name: string; status: 'pass' | 'warn' | 'fail'; detail: string }[] }> = {
      sales_rep: {
        ...
        checks: [
          ...
          { name: 'Sell project form validation', status: 'pass', detail: 'Inline validation active — required fields, email format, phone format, bill comparison all validated' },
      ...
      backend_ops: {
        ...
        checks: [
          ...
          { name: 'Communication hub', status: 'pass', detail: 'Messages persist to localStorage — conversations and history survive page refreshes' },
      ...
      installer: {
        ...
        checks: [
          ...
          { name: 'File upload validation', status: 'pass', detail: 'File type whitelist (JPG, PNG, PDF, DOC) + 25MB size limit enforced with user feedback' },
      ...
      financier: {
        ...
        checks: [
          ...
          { name: 'Dual approval for large releases', status: 'pass', detail: 'Dual-approval gate active — releases above $10K require two approvers' },
        ],
      },
    };
