...
export const SPIN_PRIZES = [
  { name: 'ASP Stealth Tee', icon: 'ST', value: 40, tier: 'normal', image: `${PRIZE_BASE}/asp_stealth_tee.svg` },
  { name: 'ASP Snapback', icon: 'SB', value: 25, tier: 'normal', image: `${PRIZE_BASE}/asp_snapback.svg` },
  { name: 'Yeti Tumbler', icon: 'YT', value: 35, tier: 'normal', image: `${PRIZE_BASE}/yeti_tumbler.svg` },
  ...
  { name: 'Diamond Jewelry', icon: 'DJ', value: 800, tier: 'super_alpha', image: `${PRIZE_BASE}/diamond_jewelry.svg` },
  { name: 'Luxury Vacation', icon: 'LV', value: 500, tier: 'super_alpha', image: `${PRIZE_BASE}/luxury_vacation.svg` },
  { name: '2x Tickets (7d)', icon: '2x', value: 170, tier: 'golden', image: `${PRIZE_BASE}/double_tickets.svg` },
  { name: '10 Hot Leads', icon: 'HL', value: 850, tier: 'super_alpha', image: `${PRIZE_BASE}/hot_leads.svg` },
  { name: 'ASP Elite Hoodie', icon: 'EH', value: 65, tier: 'normal', image: `${PRIZE_BASE}/asp_elite_hoodie.svg` },
