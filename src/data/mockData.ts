...
export const PROJECTS: Project[] = [
  ...
  makeProjectData(
    { id: 'ASP-2033', customerName: 'Marcus Thompson', address: '1120 Live Oak Trail, Austin, TX 78703', email: 'marcus.t@email.com', phone: '(512) 555-0288', status: 'active', currentMilestone: 6, totalMilestones: 7, systemSize: '6.5 kW', battery: 'Tesla Powerwall 13.5kW', soldPPW: 4.20, contractValue: 27190, repName: 'Caitlin Fox', installerName: 'SunTech Installations', addedDate: '2025-11-22', stage: 'PTO Pending', adders: [{ name: 'Battery', cost: 12000 }, { name: 'Critter Guard', cost: 800 }], siteSurveyPhotos: [], permitStatus: 'approved', roofCondition: 'good', roofIssues: [], annualUsage: 8400, documentsSignedCount: 6, totalDocuments: 6 },
