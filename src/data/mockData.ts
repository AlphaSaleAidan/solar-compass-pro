...
export const SPIN_PRIZES = [
  { name: 'ASP Stealth Tee', icon: '🖤', value: 40, tier: 'normal' },
  { name: 'ASP Snapback', icon: '⚡', value: 25, tier: 'normal' },
  { name: 'Yeti Tumbler', icon: '🧊', value: 35, tier: 'normal' },
  { name: 'ASP Shades', icon: '🔥', value: 55, tier: 'normal' },
  { name: 'AirPods Pro', icon: '🎯', value: 150, tier: 'golden' },
  { name: 'Apple Pencil', icon: '✨', value: 120, tier: 'golden' },
  { name: '$85 Cash Drop', icon: '💰', value: 85, tier: 'normal' },
  { name: 'Ray-Ban Meta', icon: '🌊', value: 300, tier: 'alpha' },
  { name: 'Meta Quest 3', icon: '🪐', value: 450, tier: 'alpha' },
  { name: 'iPad Air', icon: '💫', value: 500, tier: 'super_alpha' },
  { name: '5★ Fine Dining', icon: '🥂', value: 500, tier: 'super_alpha' },
  { name: 'Cruise Getaway', icon: '⛵', value: 400, tier: 'super_alpha' },
  { name: 'Diamond Jewelry', icon: '💎', value: 800, tier: 'super_alpha' },
  { name: 'Luxury Vacation', icon: '🏖️', value: 500, tier: 'super_alpha' },
  { name: '2x Tickets (7d)', icon: '🔮', value: 170, tier: 'golden' },
  { name: '10 Hot Leads', icon: '🎰', value: 850, tier: 'super_alpha' },
  { name: 'ASP Elite Hoodie', icon: '👑', value: 65, tier: 'normal' },
  { name: 'MagSafe Charger', icon: '⚡', value: 45, tier: 'normal' },
  { name: 'Nike Gift Card', icon: '🏆', value: 100, tier: 'golden' },
  { name: 'Beats Studio', icon: '🎶', value: 200, tier: 'alpha' },
  { name: '$50 Cash Drop', icon: '💰', value: 50, tier: 'normal' },
  { name: 'Hydro Flask', icon: '💧', value: 30, tier: 'normal' },
  { name: 'Amazon $25', icon: '🛍️', value: 25, tier: 'normal' },
];
