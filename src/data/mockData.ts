...
export const SPIN_PRIZES = [
  { name: 'ASP Stealth Tee', icon: 'ST', value: 40, tier: 'normal', image: 'https://tinyurl.com/G6czk3XUkzr55kh4oc-img' },
  { name: 'ASP Snapback', icon: 'SB', value: 25, tier: 'normal', image: 'https://tinyurl.com/fps3vK3EUax3LQZKu9-img' },
  { name: 'Yeti Tumbler', icon: 'YT', value: 35, tier: 'normal', image: 'https://tinyurl.com/CrtbjTpmyPqLQ9uDFq-img' },
  { name: 'ASP Shades', icon: 'SH', value: 55, tier: 'normal', image: 'https://tinyurl.com/ZL66wLL7yjTonF2Gu9-img' },
  { name: 'AirPods Pro', icon: 'AP', value: 150, tier: 'golden', image: 'https://tinyurl.com/SsNcDyo6izTQH62gNm-img' },
  { name: 'Apple Pencil', icon: 'PE', value: 120, tier: 'golden', image: 'https://tinyurl.com/YKKwtLAwEpM6V9Q23q-img' },
  { name: '$85 Cash Drop', icon: '$', value: 85, tier: 'normal', image: 'https://tinyurl.com/aBbmJuEsqfGo5qGSEp-img' },
  { name: 'Ray-Ban Meta', icon: 'RB', value: 300, tier: 'alpha', image: 'https://tinyurl.com/6V947GShESj3RssVf6-img' },
  { name: 'Meta Quest 3', icon: 'MQ', value: 450, tier: 'alpha', image: 'https://tinyurl.com/YCKEWLUv4set6jm4Az-img' },
  { name: 'iPad Air', icon: 'iP', value: 500, tier: 'super_alpha', image: 'https://tinyurl.com/erEPMfqHcg9QRaxH5C-img' },
  { name: '5★ Fine Dining', icon: 'FD', value: 500, tier: 'super_alpha', image: 'https://tinyurl.com/jrQXufw8uk2LaJ4Tna-img' },
  { name: 'Cruise Getaway', icon: 'CG', value: 400, tier: 'super_alpha', image: 'https://tinyurl.com/FbxtHJtFGxearNR7NY-img' },
  { name: 'Diamond Jewelry', icon: 'DJ', value: 800, tier: 'super_alpha', image: 'https://tinyurl.com/CSGGhixBwGSsEDDa2Q-img' },
  { name: 'Luxury Vacation', icon: 'LV', value: 500, tier: 'super_alpha', image: 'https://tinyurl.com/duk2XwxicXidvBcmq4-img' },
  { name: '2x Tickets (7d)', icon: '2x', value: 170, tier: 'golden', image: 'https://tinyurl.com/brZAH78QAqoEdHh8W5-img' },
  { name: '10 Hot Leads', icon: 'HL', value: 850, tier: 'super_alpha', image: 'https://tinyurl.com/TY6kTfXC3DDwqTttSH-img' },
  { name: 'ASP Elite Hoodie', icon: 'EH', value: 65, tier: 'normal', image: 'https://tinyurl.com/EjJJTiz4S3fiPVkkG4-img' },
  { name: 'MagSafe Charger', icon: 'MC', value: 45, tier: 'normal', image: 'https://tinyurl.com/9nX4DXX9aAg9PwoN5t-img' },
  { name: 'Nike Gift Card', icon: 'NK', value: 100, tier: 'golden', image: 'https://tinyurl.com/nrAMW4VUPwp9exUkbL-img' },
  { name: 'Beats Studio', icon: 'BS', value: 200, tier: 'alpha', image: 'https://tinyurl.com/6nrwYPMDG73UANLbGy-img' },
  { name: '$50 Cash Drop', icon: '$', value: 50, tier: 'normal', image: 'https://tinyurl.com/m5RZU2EvEiuhy9j8uA-img' },
  { name: 'Hydro Flask', icon: 'HF', value: 30, tier: 'normal', image: 'https://tinyurl.com/7uWenWNLeMh2Xp4dCA-img' },
  { name: 'Amazon $25', icon: 'AZ', value: 25, tier: 'normal', image: 'https://tinyurl.com/3TDXm2gMSoNv2u63aE-img' },
];
