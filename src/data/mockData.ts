...
export const SPIN_PRIZES = [
  { name: 'ASP Stealth Tee', icon: 'ST', value: 40, tier: 'normal', image: 'https://tinyurl.com/TsFrE5dTLs8YGTWuHT-img' },
  { name: 'ASP Snapback', icon: 'SB', value: 25, tier: 'normal', image: 'https://tinyurl.com/Rc4bmdpJRmP9RpAbcm-img' },
  { name: 'Yeti Tumbler', icon: 'YT', value: 35, tier: 'normal', image: 'https://tinyurl.com/MaYQBkynDRTnMDLnMD-img' },
  { name: 'ASP Shades', icon: 'SH', value: 55, tier: 'normal', image: 'https://tinyurl.com/mXYWfixSHmBCyPveiq-img' },
  { name: 'AirPods Pro', icon: 'AP', value: 150, tier: 'golden', image: 'https://tinyurl.com/ESUkvJWH7whz8k7buL-img' },
  { name: 'Apple Pencil', icon: 'PE', value: 120, tier: 'golden', image: 'https://tinyurl.com/H8g2RoAfaEYkyKfgpH-img' },
  { name: '$85 Cash Drop', icon: '$', value: 85, tier: 'normal', image: 'https://tinyurl.com/5k9kBmXebrUfb4zWsy-img' },
  { name: 'Ray-Ban Meta', icon: 'RB', value: 300, tier: 'alpha', image: 'https://tinyurl.com/aij2m9SgDFzGciros7-img' },
  { name: 'Meta Quest 3', icon: 'MQ', value: 450, tier: 'alpha', image: 'https://tinyurl.com/YQGRf8Ui2NBNNqC5kv-img' },
  { name: 'iPad Air', icon: 'iP', value: 500, tier: 'super_alpha', image: 'https://tinyurl.com/RECgfHiCEHPUZxjLfM-img' },
  { name: '5★ Fine Dining', icon: 'FD', value: 500, tier: 'super_alpha', image: 'https://tinyurl.com/dkptcjAyMwRfffDNAh-img' },
  { name: 'Cruise Getaway', icon: 'CG', value: 400, tier: 'super_alpha', image: 'https://tinyurl.com/EMYDihAWXvnF8xypzR-img' },
  { name: 'Diamond Jewelry', icon: 'DJ', value: 800, tier: 'super_alpha', image: 'https://tinyurl.com/djBqEnFBSQ47SfCvvn-img' },
  { name: 'Luxury Vacation', icon: 'LV', value: 500, tier: 'super_alpha', image: 'https://tinyurl.com/A2BJAWYRU9xHXrimuT-img' },
  { name: '2x Tickets (7d)', icon: '2x', value: 170, tier: 'golden', image: 'https://tinyurl.com/DLrnYCf2QnMX4RcRDo-img' },
  { name: '10 Hot Leads', icon: 'HL', value: 850, tier: 'super_alpha', image: 'https://tinyurl.com/T46DXX4LZpfdG5R3TU-img' },
  { name: 'ASP Elite Hoodie', icon: 'EH', value: 65, tier: 'normal', image: 'https://tinyurl.com/cAS3ssjWRvtu2YW8Lq-img' },
  { name: 'MagSafe Charger', icon: 'MC', value: 45, tier: 'normal', image: 'https://tinyurl.com/DWNffk7ngzWJTFioMH-img' },
  { name: 'Nike Gift Card', icon: 'NK', value: 100, tier: 'golden', image: 'https://tinyurl.com/MQQTKbnTQMpGCX6Tt4-img' },
  { name: 'Beats Studio', icon: 'BS', value: 200, tier: 'alpha', image: 'https://tinyurl.com/PmVCfXHhZeD9aL7Trc-img' },
  { name: '$50 Cash Drop', icon: '$', value: 50, tier: 'normal', image: 'https://tinyurl.com/87wdEqaNdR6qEXpmY5-img' },
  { name: 'Hydro Flask', icon: 'HF', value: 30, tier: 'normal', image: 'https://tinyurl.com/Xuq9WnsELJSSXWUb9k-img' },
  { name: 'Amazon $25', icon: 'AZ', value: 25, tier: 'normal', image: 'https://tinyurl.com/jcNPpKojgYf4wKEmXf-img' },
];
